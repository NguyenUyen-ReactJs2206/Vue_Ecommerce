    ...
    <div class="overlay" @click.self="$emit('closePopup')">
      <div class="asideFilter">
        ...
        <div class="asideFilter__search-filter">
          <router-link
            :to="`${path.home}`"
            class="asideFilter__link asideFilter__link--flex asideFilter__link--uppercase"
          >
            <svg
...
import RatingStart from '../../pages/ProductList/components/RatingStart/RatingStart.vue';
